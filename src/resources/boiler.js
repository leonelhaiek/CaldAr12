  ...
  fields:
    ...
    editForm:
    {
      ...
      [
        ...
        {id:'type',type: 'number', name:'Type' , onError:'Must have at least 1 digits', pattern: /^[0-9]{1,}$/},
        {id:'maintenance_rate',type: 'text', name:'Maintenance Rate', onError:'Must have at least 3 characters', pattern: /^[a-z]{1,}$/i},
        {id:'hour_maintaince_cost',type: 'number', name:'Hour Maintenance Cost', onError:'Must have at least 1 digits', pattern: /^[0-9]{1,}$/},
